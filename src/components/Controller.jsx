    ...
    <ControlBar>
      <ArrayBar>
        <TextField
            ...
            size="small"
            width="100px"
            style={{ flexGrow: 1, margin: '0px 10px 0px 200px' }}
          />
        <Button
          variant="contained"
          color="primary"
          onClick={generate}
          style ={{margin : '0px 200px 0px 10px',backgroundColor : "#f6a62b"}}
        >
          Generate
        </Button>
      ...
      <ExecutionBar style ={{marginTop : 30 ,marginBottom : 30}}>
        <Slider
          key={`slider-${speed}`}
          defaultValue={speed}
          ...
          min={1}
          max={10}
          style={{ flexGrow: 1, flexBasis: "100%" , margin: '0px 10px 0px 200px' ,color : "#f50057" }}
        />

        <div style={{ display: "flex", margin : '0px 200px 0px 10px' }}>
          {getProgressButton()}
          {resetElement}
        </div>
      </ExecutionBar>
